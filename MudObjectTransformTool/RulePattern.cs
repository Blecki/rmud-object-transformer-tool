    ...
    public class RulePattern : Pattern
    {
        ...
        public RulePattern()
        {
            if (StandardRuleArguments == null)
            {
                ...
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("after every command", "Actor actor");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("player joined", "Actor actor");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("player left", "Actor actor");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("silly?", "MudObject item", "Boolean value");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can silly?", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("silly", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can dance?", "MudObject actor");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("dance", "MudObject actor");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can introduce?", "MudObject actor", "MudObject itroductee");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("introduce", "MudObject actor", "MudObject introductee");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can remove?", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("removed", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("wearable?", "MudObject item", "Boolean value");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can wear?", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("worn", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can converse?", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("greet", "MudObject actor", "MudObject npc");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("list topics", "MudObject actor");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("unlocked", "MudObject actor", "MudObject item", "MudObject key");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can look relloc?", "MudObject actor", "MudObject item", "RelativeLocations relloc");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("look relloc", "MudObject actor", "MudObject item", "RelativeLocations relloc");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can close?", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("closed", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("quest reset", "MudObject quest", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("quest accepted", "MudObject actor", "MudObject quest");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("quest completed", "MudObject actor", "MudObject quest");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("quest failed", "MudObject actor", "MudObject quest");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("quest abandoned", "MudObject actor", "MudObject quest");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("quest available?", "MudObject actor", "MudObject quest", "Boolean value");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("quest complete?", "MudObject actor", "MudObject quest", "Boolean value");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("quest failed?", "MudObject actor", "MudObject quest", "Boolean value");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("heartbeat");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("update", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("printed name", "MudObject actor", "MudObject item", "String article", "String value");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("topic available?", "MudObject actor", "MudObject npc", "MudObject topic", "Boolean value");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("topic response", "MudObject actor", "MudObject npc", "MudObject topic");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can access channel?", "MudObject actor", "MudObject channel");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can put?", "MudObject actor", "MudObject item", "MudObject container", "RelativeLocations relloc");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("put", "MudObject actor", "MudObject item", "MudObject container", "RelativeLocations relloc");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("lockable?", "MudObject item", "Boolean value");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can lock?", "MudObject actor", "MudObject item", "MudObject key");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("locked", "MudObject actor", "MudObject item", "MudObject key");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can open?", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("openable?", "MudObject item", "Boolean value");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("opened", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can drop?", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("drop", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("inventory", "MudObject actor");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("speak", "MudObject actor", "String text");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("emote", "MudObject actor", "String text");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can take?", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("take", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can go?", "MudObject actor", "Link link");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("go", "MudObject actor", "Link link");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("can examine?", "MudObject actor", "MudObject item");
                MudObjectTransformTool.RulePattern.AddStandardRuleArgumentTypes("describe", "MudObject actor", "MudObject item");
